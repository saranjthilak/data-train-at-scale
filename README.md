...
WagonCab's ML stack is running on Python 3.10.6, a stable version which has served WagonCab well: *"If it ain't broke, don't fix it."* So let's use that same Python version.
